...
if (isset($_POST['shape'])) {
  ...
  $diamond  = "SELECT * FROM `diamonds` WHERE diamond_shape_id = '$shape_id' AND diamond_type = 'Fancy' AND diamond_lot_no LIKE 'F%' AND diamond_status NOT IN ('Invoiced','Deleted') ORDER BY diamond_id DESC";
  $sql = mysqli_query($conn, $diamond);
}else {
  $diamond  = "SELECT * FROM `diamonds` WHERE diamond_shape_id = 2 AND `diamond_size` >= 0.90 AND diamond_type = 'Fancy' AND diamond_lot_no LIKE 'F%' AND diamond_status NOT IN ('Invoiced','Deleted') ORDER BY diamond_lot_no DESC";
  $sql = mysqli_query($conn, $diamond);
}
